...
export default function Home() {
  return (
    <>
      ...
      <main id="invitation" className="min-h-screen bg-gradient-to-b from-amber-950 via-stone-900 to-rose-950 text-amber-50 flex flex-col items-center justify-between p-4 sm:p-8 font-sans relative overflow-hidden py-16">
        ...
        <section className="relative z-10 w-full max-w-xl bg-stone-900/90 backdrop-blur-xl border-2 border-amber-500/40 rounded-[2.5rem] p-6 sm:p-10 shadow-[0_0_50px_rgba(217,119,6,0.15)] text-center space-y-8 my-auto">
          ...
          <div className="flex flex-col items-center space-y-2">
            <div className="text-2xl text-amber-400 font-serif">🛕</div>
